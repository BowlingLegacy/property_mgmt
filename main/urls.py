...
urlpatterns = [
    ...
    path("sms-paper-consent/", views.sms_paper_consent, name="sms_paper_consent"),
    ...
    path("landlord-dashboard/residents/former/", views.former_tenant_files, name="former_tenant_files"),
    path("landlord-dashboard/residents/begin-tenancy/", views.begin_new_tenancy, name="begin_new_tenancy"),
    path("landlord-dashboard/residents/<int:application_id>/end-tenancy/", views.end_resident_tenancy, name="end_resident_tenancy"),
    ...
    path("resident-files/<int:application_id>/move-out-statement/", views.move_out_statement, name="move_out_statement"),
    ...
    path("accounting/receipts/<int:receipt_id>/edit/", views.edit_accounting_receipt, name="edit_accounting_receipt"),
    path("accounting/receipts/<int:receipt_id>/split/", views.split_accounting_receipt, name="split_accounting_receipt"),
