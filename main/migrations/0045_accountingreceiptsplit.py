    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("category", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name="receipt_splits", to="main.expensecategory")),
                ("created_by", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="created_receipt_splits", to=settings.AUTH_USER_MODEL)),
