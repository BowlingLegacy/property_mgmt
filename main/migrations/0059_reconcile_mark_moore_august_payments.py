...
MARKER = "Mark Moore August 2026 payment reconciliation migration 0059"


def ensure_august_payment(Payment, resident, payment_type, target):
    paid = (
...
def reconcile_mark_moore_august_payments(apps, schema_editor):
    ...
    ensure_august_payment(Payment, resident, "rent", rent)
    ensure_august_payment(Payment, resident, "utility", utilities)
...
class Migration(migrations.Migration):
    dependencies = [("main", "0058_record_diane_torgerson_cleaning_payments")]

    operations = [migrations.RunPython(reconcile_mark_moore_august_payments, noop_reverse)]
