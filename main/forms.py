...
class AccountingReceiptForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            "receipt_file": "Upload the original receipt, invoice, or PDF. Rental Ready Pro stores it as proof.",
...
class HousingApplicationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "employment_length": forms.TextInput(attrs={"class": "form-control", "placeholder": "Example: 2 years on the job, 5 years SSDI, 8 months at current employer"}),
            "has_vehicle": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "vehicle_description": forms.TextInput(attrs={"class": "form-control", "placeholder": "Vehicle type, parking needs, or write none"}),
